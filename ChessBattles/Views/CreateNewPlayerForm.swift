...
struct CreateNewPlayerForm: View {
    ...
    @State private var selectedCountry = "Afghanistan"
    ...
    var body: some View {
        NavigationView{
            VStack{
                Form{
                    ...
                    Section{
                        ...
                        TextField("Enter the player name...",text:$name)
                            .accessibilityIdentifier("createName")
                    ...
                    Section{
                        ...
                        if let index:Int = countries.firstIndex(of: selectedCountry) {
                            HStack{
                                Spacer()
                    ...
                    Section{
                        ...
                        TextField("enter your birth year...",text:$birthYear)
                            .accessibilityIdentifier("createDOB")
                            .autocapitalization(.words)
                    ...
                    Section{
                        ...
                        TextField("Enter the elo of your player...",text:$rating)
                            .accessibilityIdentifier("createRating")
            ...
            .navigationBarItems(leading: Button(action: {
                ...
                if(name == "" || rating == "" || birthYear == "" || selectedCountry == ""){
                    errorMsg = "Please Make sure to Fill form correctly"
                }else{
                    model.addData(name: name, rating: rating, birthyear: birthYear, country: selectedCountry)
                    presentationMode.wrappedValue.dismiss()
                }
            }){
                Text("Done")
 ...
 struct CreateNewPlayerForm_Previews: PreviewProvider {
